...
public class TransferServiceSyncImplTest {

    private static Logger logger = LogManager.getLogger(TransferServiceSyncImplTest.class);
    private static TransferServiceSyncImpl transferService;
    private static AccountDao accountDAO;

    @BeforeClass
    public static void setup() {
        DaoFactory.getInstance().initDb();
        transferService = new TransferServiceSyncImpl();
