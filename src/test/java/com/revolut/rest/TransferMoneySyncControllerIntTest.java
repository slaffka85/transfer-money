...
public class TransferMoneySyncControllerIntTest extends AbstractTransferMoneyControllerIntTest {


    private static final String path = "/api/transfer-money-sync/";
